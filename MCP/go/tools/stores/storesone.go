...
func StoresoneHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/ecommerce/store%s", cfg.BaseURL, queryString)
		...
		var result models.GetStoreResponse
...
func CreateStoresoneTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_ecommerce_store",
		mcp.WithDescription("Get Store"),

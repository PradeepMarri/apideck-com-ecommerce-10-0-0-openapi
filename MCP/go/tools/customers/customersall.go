...
func CustomersallHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/ecommerce/customers%s", cfg.BaseURL, queryString)
		...
		var result models.GetEcommerceCustomersResponse
...
func CreateCustomersallTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_ecommerce_customers",

...
func CustomersoneHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/ecommerce/customers/%s%s", cfg.BaseURL, id, queryString)
		...
		var result models.GetEcommerceCustomerResponse
...
func CreateCustomersoneTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_ecommerce_customers_id",
